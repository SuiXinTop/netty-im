package com.suixin.security.advice;

import com.suixin.common.exception.UnauthorizedException;
import com.suixin.common.util.RequestUtil;
import com.suixin.redis.service.RedisService;
...
public class TokenAdvice {
     ...
     * 定义一个切点
     */
    @Pointcut("@annotation(com.spring.security.annotation.PreAuth)")
